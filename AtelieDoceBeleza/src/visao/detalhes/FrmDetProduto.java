 ...
 * @author Rafael
 */
public class FrmDetProduto extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmDetProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        desabilitarBotoes();
        desabilitarCampos();
    ...
    private void initComponents() {
        ...
        txtDescricao.setText("Produto Teste");

        txtValorRomance.setText("10,00");

        txtValorSugerido.setText("20,00");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDetProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDetProduto dialog = new FrmDetProduto(new javax.swing.JFrame(), true);
